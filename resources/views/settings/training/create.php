    ...
    <table class="widefat striped" id="ml_email_main_col_config">
        ...
        <tr>
            ...
            <textarea style="min-width: 100%;" class="form-control" name="embed_video" id="embed_video"
                      oninput="this.setCustomValidity(this.value.trim() === '' ? '<?php esc_attr_e( 'The embed Video cannot be empty or just whitespace.', 'dt-home' ); ?>' : '')"
                      required></textarea>
            </td>
        </tr>
        <tr>
            <td style="vertical-align: middle;">
                ...
                <span class="tooltip">[?]
                <span
                    class="tooltiptext"><?php esc_html_e( 'Specify the anchor text for the video.', 'dt-home' ) ?></span>
            </span>
            </td>
            <td colspan="2">
                <input style="min-width: 100%;" class="form-control" type="text" name="anchor" id="anchor"
                       pattern=".*\S+.*"
                       title="<?php esc_attr_e( 'The anchor text cannot be empty or just whitespace.', 'dt-home' ); ?>"
                       required />
            </td>
        </tr>
        <tr>
